    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <button @click="sidebarOpen = true" class="sm:hidden p-2 mr-2 text-slate-500 hover:text-slate-700 hover:bg-slate-100 focus:outline-none rounded-md transition duration-150 ease-in-out">
